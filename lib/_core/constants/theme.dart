...
ThemeData theme() {
  ...
  return ThemeData(
    ...
    colorScheme: ColorScheme.fromSeed(
      ...
      // onPrimary, onSecondary 등은 seedColor로부터 자동 생성되거나, 필요시 명시적으로 지정 가능
    ),
...
InputDecorationTheme _inputDecorationTheme(TextTheme textTheme) {
  // InputDecoration의 labelStyle, hintStyle 등은 이미 특정 회색 계열로 지정되어 있으므로
  // 기본 텍스트 테마 변경에 큰 영향을 받지 않거나, 필요시 여기서 직접 조정할 수 있습니다.
