...
abstract class $ApiResponseCopyWith<T, $Res> {
  ...
  @useResult
  $Res call({bool success, T? response, ApiError? error});
...
class _$ApiResponseImpl<T> implements _ApiResponse<T> {
  const _$ApiResponseImpl({required this.success, this.response, this.error});
  ...
  @override
  String toString() {
    return 'ApiResponse<$T>(success: $success, response: $response, error: $error)';
  }
