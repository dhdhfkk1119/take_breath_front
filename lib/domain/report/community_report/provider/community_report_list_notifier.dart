...
class CommunityReportListNotifier
  ...
  @override
  BaseState<List<CommunityReportListResponse>> build() {
    communityReportRepository = ref.read(communityReportRepositoryProvider);

    return BaseState<List<CommunityReportListResponse>>(
      isLoading: false,
      error: null,
      data: [],
    );
  ...
  Future<void> fetchList() async {
    ...
    try {
      final List<CommunityReportListResponse> newReports =
          await communityReportRepository.findMyReports(
  ...
  Future<void> loadMore() async {
    ...
    try {
      final List<CommunityReportListResponse> moreReports =
          await communityReportRepository.findMyReports(
              page: _currentPage, size: 10);
      ...
      final List<CommunityReportListResponse> combinedList = [
        ...state.data!,
        ...moreReports,
      ];
